...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_LEGS: return  "Jambieres";// session->GetTrinityString(LANG_SLOT_NAME_LEGS);
        ...
        case EQUIPMENT_SLOT_RANGED: return  "Distance";// session->GetTrinityString(LANG_SLOT_NAME_RANGED);
